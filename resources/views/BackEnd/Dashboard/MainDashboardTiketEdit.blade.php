...
@section('container-create')
    ...
    <div class="col-lg-8">
        <form method="post" action="/dashboard/tiket/{{ $tiket->id }}" enctype="multipart/form-data">
            @csrf

            @method('put')
            <div class="mb-3">
                <label for="nama_tiket" class="form-label">Nama Tiket</label>
                <input value="{{ old('nama_tiket', $tiket->nama_tiket) }}"; type="text" class="form-control";
                    id="nama_tiket" ; aria-describedby="emailHelp"; name="nama_tiket" ; autofocus;>
                @error('nama_tiket')
                    <div class="pesaneror">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input value="{{ old('harga_tiket', $tiket->harga_tiket) }}"; type="number" class="form-control";
                    id="harga_tiket" ; aria-describedby="emailHelp"; name="harga_tiket" ;>
            ...
            <div class="mb-3">
                ...
                <input value="{{ old('tanggal_konser', $tiket->tanggal_konser) }}"; type="text" class="form-control";
                    id="tanggal_konser" ; aria-describedby="emailHelp"; name="tanggal_konser" ;>
            ...
            <div class="mb-3">
                ...
                <input value="{{ old('lokasi_tiket', $tiket->lokasi_tiket) }}"; type="text" class="form-control";
                    id="lokasi_tiket" ; aria-describedby="emailHelp"; name="lokasi_tiket" ;>
