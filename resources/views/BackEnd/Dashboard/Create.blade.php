    ...
    <div class="col-lg-8">
        ...
        <form method="post" action="/dashboard" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input value="{{ old('judul_berita',$Berita->judul_berita) }}"; type="text" class="form-control"; id="judul_berita" ;
            ...
            <div class="mb-3">
                ...
                <input value="{{ old('nama_konser',$Berita->nama_konser) }}"; type="text" class="form-control"; id="nama_konser" ;
                aria-describedby="emailHelp"; name="nama_konser" ; autofocus;>
            ...
            <div class="mb-3">
                ...
                <select  id="spotlight" name="spotlight"class="form-select">
            ...
            <div class="mb-3">
                ...
                <input value="{{ old('isi_berita',$Berita->isi_berita) }}"id="isi_berita" type="hidden"
                    name="isi_berita">
      ...
      <label class="form-check-label" for="exampleCheck1">Check me out</label>
            ...
            <button type="submit" class="btn btn-primary" style="margin-top:3%;">Create News</button>
        </form>
    </div>
