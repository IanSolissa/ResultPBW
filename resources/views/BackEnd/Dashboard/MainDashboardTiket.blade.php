...
@section('container-dashboard')
    {{-- <h1>{{ $tiket->artis->implode('nama_artis') }}</h1> --}}
    {{-- @if ($Berita->count()) --}}
    ...
    <a href="/dashboard/create-tiket" class="btn btn-primary mb-3">Create Tiket</a>
            ...
            <table class="table table-striped table-sm">
                <thead>
                    <tr>
                        ...
                        <th scope="col">Category Tiket</th>
                        <th scope="col">Maks Pemesanan</th>
                        <th scope="col">Tanggal Konser</th>
                        <th scope="col">Pre-release</th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>{{ $tiket->tanggal_konser }}</td>
                        <td>
                            @if ($tiket->prerelease > 0)
                                True
                            @else
                                False
                            @endif
                        ...
                        <td>
                            <form action="/dashboard/tiket/{{ $tiket->id }}/edit" method="get">
                                @csrf
                                <a href="/dashboard/tiket/{{ $tiket->id }}/edit">
                                    <button class="btn-delete d-inline">
                                        <span class="icon-wrapper bg-color-yellow">
                                            <svg class="icon-edit" width="25px" height="34px" viewBox="0 -0.5 21 21"
                                                ...
                                                <g id="SVGRepo_iconCarrier">
                                                    ...
                                                    <g id="Page-1" stroke="none" stroke-width="1" fill="none"
                                                        ...
                                                        <g id="Dribbble-Light-Preview"
                                                            transform="translate(-99.000000, -400.000000)" fill="#000005">
                        ...
                        <td>
                            <form action="/dashboard/tiket/{{ $tiket->id }}" method="post" class="d-inline">
                                @csrf
